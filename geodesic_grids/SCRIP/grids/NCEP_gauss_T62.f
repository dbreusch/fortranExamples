!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! 1/26/06, dbr, changed to do lats N to S for NCEP
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
...
!-----------------------------------------------------------------------
     ...
     &             grid_name = 'NCEP T62 Gaussian Grid',
     &             grid_file_out = 'remap_grid_T62_NCEP.nc'
...
! flip, then swap -- to match NCEP's N-to-S ordering
        minlat = -minlat
        maxlat = -maxlat
        templat = minlat
        minlat = maxlat
